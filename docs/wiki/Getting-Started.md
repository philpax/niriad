...
> [!NOTE]
> This is the **niriad** fork, so the shipped default config is re-themed around sway-style binds: <kbd>Mod</kbd>+<kbd>hjkl</kbd> is *spatial* focus (by screen direction), <kbd>Mod</kbd>+<kbd>Shift</kbd>+<kbd>hjkl</kbd> moves, and there are binds for splits and tabbed/stacked containers. The classic niri binds are still in the config, commented out; uncomment that block if you prefer them. niri also renames the "column" concept to "section" (old `column`-named config nodes still work via a compat shim). The table below lists the fork's defaults.

The general system: <kbd>Mod</kbd>+<kbd>hjkl</kbd> (or arrows) focuses in a screen direction, and adding <kbd>Shift</kbd> moves the focused window that way; <kbd>Mod</kbd>+<kbd>Ctrl</kbd>+<kbd>hjkl</kbd> targets monitors.
...
| <kbd>Mod</kbd><kbd>H</kbd>/<kbd>J</kbd>/<kbd>K</kbd>/<kbd>L</kbd> or <kbd>Mod</kbd><kbd>←</kbd>/<kbd>↓</kbd>/<kbd>↑</kbd>/<kbd>→</kbd> | Focus left/down/up/right (spatial, by screen direction) |
| <kbd>Mod</kbd><kbd>Shift</kbd><kbd>H</kbd>/<kbd>J</kbd>/<kbd>K</kbd>/<kbd>L</kbd> or <kbd>Mod</kbd><kbd>Shift</kbd> + arrows | Move the focused window left/down/up/right |
| <kbd>Mod</kbd><kbd>B</kbd> / <kbd>Mod</kbd><kbd>V</kbd> | Lay the container out as horizontal / vertical split (`splith`/`splitv`) |
| <kbd>Mod</kbd><kbd>W</kbd> / <kbd>Mod</kbd><kbd>S</kbd> | Lay the container out as tabbed / stacked |
| <kbd>Mod</kbd><kbd>E</kbd> | Toggle the container between horizontal and vertical split |
| <kbd>Mod</kbd><kbd>Shift</kbd><kbd>[</kbd> / <kbd>Mod</kbd><kbd>Shift</kbd><kbd>]</kbd> | Move the focused tab left / right within its tabbed container |
| <kbd>Mod</kbd><kbd>Ctrl</kbd><kbd>H</kbd>/<kbd>J</kbd>/<kbd>K</kbd>/<kbd>L</kbd> | Focus the monitor to the side |
| <kbd>Mod</kbd><kbd>Ctrl</kbd><kbd>Shift</kbd><kbd>H</kbd> / <kbd>Mod</kbd><kbd>Ctrl</kbd><kbd>Shift</kbd><kbd>L</kbd> | Move the focused section to the monitor to the left / right |
| <kbd>Mod</kbd><kbd>1</kbd>…<kbd>9</kbd> | Switch to workspace 1…9 |
| <kbd>Mod</kbd><kbd>Shift</kbd><kbd>1</kbd>…<kbd>9</kbd> | Move the focused section to workspace 1…9 |
| <kbd>Mod</kbd><kbd>PageDown</kbd> / <kbd>Mod</kbd><kbd>PageUp</kbd> | Switch to the workspace below / above |
| <kbd>Mod</kbd><kbd>R</kbd> | Toggle between preset section widths |
| <kbd>Mod</kbd><kbd>C</kbd> | Center the focused section within view |
| <kbd>Mod</kbd><kbd>-</kbd> / <kbd>Mod</kbd><kbd>=</kbd> | Decrease / increase section width by 10% |
...
| <kbd>Mod</kbd><kbd>Shift</kbd><kbd>Space</kbd> | Move the focused window between the floating and the tiling layout |
| <kbd>Mod</kbd><kbd>Space</kbd> | Switch focus between the floating and the tiling layout |
| <kbd>Mod</kbd><kbd>O</kbd> | Toggle the Overview |
